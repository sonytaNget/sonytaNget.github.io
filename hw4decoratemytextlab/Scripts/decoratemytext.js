window.onload = function() {
    ...
    // Button Change Color
    var btnChangeColor = document.getElementById("color"); 
    btnChangeColor.onclick = changeColor;

    // Button Change Font Size
    var btnChangeFontSize = document.getElementById("fontSize"); 
    btnChangeFontSize.onclick = changeFontSize;

    // Button Change Font Weight
    var btnChangeFontWeight = document.getElementById("fontWeight"); 
    btnChangeFontWeight.onclick = changeFontWeight;
